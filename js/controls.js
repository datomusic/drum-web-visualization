...
export const CC_CONTROLS = {
  ...
  9: { id: 'swing-display', type: 'display', indicatorId: null, label: 'Swing' },
  ...
  21: { id: 'pitch-knob-4', type: 'slider', indicatorId: 'pitch-indicator-4', label: 'Pitch 1', dir: [0.707, -0.707], travel: 84.85 },
  22: { id: 'pitch-knob-1', type: 'slider', indicatorId: 'pitch-indicator-1', label: 'Pitch 2', dir: [0.707, 0.707], travel: 84.85 },
  23: { id: 'pitch-knob-2', type: 'slider', indicatorId: 'pitch-indicator-2', label: 'Pitch 3', dir: [-0.707, 0.707], travel: 84.85 },
  24: { id: 'pitch-knob-3', type: 'slider', indicatorId: 'pitch-indicator-3', label: 'Pitch 4', dir: [-0.707, -0.707], travel: 84.85 },
...
export const NOTE_CONTROLS = {
  // Track 1
  30: { padId: 'pad-1', track: 1, sample: 1 },
  31: { padId: 'pad-1', track: 1, sample: 2 },
  32: { padId: 'pad-1', track: 1, sample: 3 },
  33: { padId: 'pad-1', track: 1, sample: 4 },
  34: { padId: 'pad-1', track: 1, sample: 5 },
  35: { padId: 'pad-1', track: 1, sample: 6 },
  36: { padId: 'pad-1', track: 1, sample: 7 },
  37: { padId: 'pad-1', track: 1, sample: 8 },
  // Track 2
  38: { padId: 'pad-2', track: 2, sample: 1 },
  39: { padId: 'pad-2', track: 2, sample: 2 },
  40: { padId: 'pad-2', track: 2, sample: 3 },
  41: { padId: 'pad-2', track: 2, sample: 4 },
  42: { padId: 'pad-2', track: 2, sample: 5 },
  43: { padId: 'pad-2', track: 2, sample: 6 },
  44: { padId: 'pad-2', track: 2, sample: 7 },
  45: { padId: 'pad-2', track: 2, sample: 8 },
  // Track 3
  46: { padId: 'pad-3', track: 3, sample: 1 },
  47: { padId: 'pad-3', track: 3, sample: 2 },
  48: { padId: 'pad-3', track: 3, sample: 3 },
  49: { padId: 'pad-3', track: 3, sample: 4 },
  50: { padId: 'pad-3', track: 3, sample: 5 },
  51: { padId: 'pad-3', track: 3, sample: 6 },
  52: { padId: 'pad-3', track: 3, sample: 7 },
  53: { padId: 'pad-3', track: 3, sample: 8 },
  // Track 4
  54: { padId: 'pad-4', track: 4, sample: 1 },
  55: { padId: 'pad-4', track: 4, sample: 2 },
  56: { padId: 'pad-4', track: 4, sample: 3 },
  57: { padId: 'pad-4', track: 4, sample: 4 },
  58: { padId: 'pad-4', track: 4, sample: 5 },
  59: { padId: 'pad-4', track: 4, sample: 6 },
  60: { padId: 'pad-4', track: 4, sample: 7 },
  61: { padId: 'pad-4', track: 4, sample: 8 },
};
